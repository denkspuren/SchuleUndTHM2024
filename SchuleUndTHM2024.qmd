---
title: "<span style='color:red;'>g</span><span style='color:black;'>KI</span> in der Bildung:<br>Chancen und Herausforderungen"
...
format:
    revealjs:
        theme: white
        slideNumber: true
        footer: "Leitungstreffen Schule & THM, 10. Dez. 2024"
...
Probiere mit einer GKI die Fortsetzung des Satzes "Das ist ein Haust" zu finden. Das ist erstaunlich schwierig! Warum: Weil Sie an Tokengrenzen stößt. Das behindert eindeutig die sprachliche Kreativität.
:::
...
> Die damit verbundenen Problemfelder<br>stelle ich gesondert vor
...
- Wenn Menschen zusammen sind, können Sie sich eine Verfassung, Spielregeln, eine Geschäftsordnung geben -- weil sie miteinander auskommen wollen
...
<!--
## Rückbesinnung Didaktik[^Didaktik]
...
* Bsp.: Programmieraufgabe `1.234.567`
* Das überforderte, weinende Kind
* Schüler_in mit ADHS
* Ethische Blindheit
